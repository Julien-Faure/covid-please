...
import {StudentDisruptor} from "./distrubtors/StudentDisruptor";
import {SportDisruptor} from "./distrubtors/SportDisruptor";
...
export class ContextMasterDisruptor {
    ...
    constructor() {
        ...
        this.disruptors.push(new SportDisruptor(0.05, 0.1));
    }
